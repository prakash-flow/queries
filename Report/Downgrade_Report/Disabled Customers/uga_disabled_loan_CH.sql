...
SELECT 
    ...
    if(
      ifNull(arrayMax(arrayFilter(x -> x <= last_upgraded_amt_raw, [250000,500000,750000,1000000,1500000,2000000,2500000,3000000,4000000,5000000])), 0) = 0,
      last_upgraded_amt_raw,
      arrayMax(arrayFilter(x -> x <= last_upgraded_amt_raw, [250000,500000,750000,1000000,1500000,2000000,2500000,3000000,4000000,5000000]))
